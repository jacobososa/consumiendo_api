...
class BuscadorPermisos extends StatefulWidget {
  const BuscadorPermisos({super.key});

  @override
  _BuscadorPermisosState createState() => _BuscadorPermisosState();
}

class _BuscadorPermisosState extends State<BuscadorPermisos> {
